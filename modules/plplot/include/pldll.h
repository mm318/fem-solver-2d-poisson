...
// then)
#if defined ( plplotLIB_TAG_EXPORTS )
...
#if defined ( plplotcxxLIB_TAG_EXPORTS )
...
#if defined ( plplotf77cLIB_TAG_EXPORTS )
...
#if defined ( plplotf95cLIB_TAG_EXPORTS )
...
#if defined ( plplotwxwidgetsLIB_TAG_EXPORTS )
...
#if defined ( tclmatrixLIB_TAG_EXPORTS )
...
#if defined ( plplottcltkLIB_TAG_EXPORTS )
...
#if defined ( plplotgnome2LIB_TAG_EXPORTS )
...
#if defined ( plplotqtLIB_TAG_EXPORTS )
